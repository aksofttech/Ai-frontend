  ...
  return (
    ...
    >
      ...
      <div className="absolute w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-80 h-80 rounded-full" style={{ background: 'radial-gradient(circle, rgba(107,92,231,0.2) 0%, transparent 70%)' }} />
        <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full" style={{ background: 'radial-gradient(circle, rgba(255,200,180,0.25) 0%, transparent 70%)' }} />
      </div>
      ...
      >
        ...
        <div className="rounded-3xl p-10 cs-shadow-lg"
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <label className="flex text-sm font-semibold mb-1.5 justify-between" style={{ color: '#1A1A2E' }}>
                Password
                <Link href="/forgot-password" className="font-medium transition-colors" style={{ color: '#6B5CE7' }}>Forgot?</Link>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
          ...
          <p className="mt-6 text-center text-sm" style={{ color: '#5A5A72' }}>
            ...
            <Link href="/signup" className="font-semibold transition-colors" style={{ color: '#6B5CE7' }}>
              Sign up for free
            </Link>
          </p>
        </div>
